...
import '../../App.css';
import footer_logo from '../../assets/images/plane.svg';
  ...
  render() {
    ...
    return (
      <div>
          ...
          <header class="d-flex align-items-center justify-content-between px-3 py-4 mx-auto">
            ...
            <div id="guest" class="d-flex align-items-center">
              <div class=" position-relative">
                <Link
                  to="/login"
                  className="btn dropdown-reveal text-teal px-3 d-block font-weight"
                >
                  Log in
                </Link>
                {/* <a class="btn dropdown-reveal text-teal px-3 d-block font-weight" href="/login">
                  Log in
                </a> */}
              </div>
              <Link
                to="/signup"
                className="btn bg-teal text-white px-3 py-2 rounded shadow font-weight"
              >
                Sign up
              </Link>
              {/* <a class="btn bg-teal text-white px-3 py-2 rounded shadow font-weight" href="/signup">
                Sign up
              </a> */}
            </div>
          </header>
         ...
         <div class="bg-facets">
          <div className="container mx-auto px-3">
            <div className="d-flex">
              <div className="box-width-8 d-block"></div>
              <div className="box-width-29 d-block">
                <div class="d-flex flex-column h-100 justify-content-center">
                  <h1 class="text-left text-charcoal font-bold leading-tight pt-5">
                    <span class="text-swap-plane">
                      Less stress when sharing expenses{' '}
                      <span class="text-plane text-teal">on trips.</span>
                    </span>
                    <span class="text-swap-house hidden">
                      Less stress when sharing expenses{' '}
                      <span class="text-house text-purple hidden">with housemates.</span>
                    </span>
                    <span class="text-swap-heart hidden">
                      Less stress when sharing expenses{' '}
                      <span class="text-heart text-red hidden">with your partner.</span>
                    </span>
                    <span class="text-swap-any hidden">
                      Less stress when sharing expenses{' '}
                      <span class="text-any text-teal hidden">with anyone.</span>
                    </span>
                  </h1>
                  <ul class="d-flex align-items-center justify-content-start mt-4 p-0">
                    <li class="sm-icon sm-plane ml-0 no-bullet">
                      <a href="/" class="text-teal sm-plane nav-icon">
                        <svg
                          class="fill-current width-svg"
                    ...
                    <li class="sm-icon sm-house ml-0 no-bullet">
                      <a href="/" class="text-purple sm-house d-flex align-items-center nav-icon">
                        <svg
                          class="fill-current width-svg opacity"
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 34 32"
                        >
                    ...
                    <li class="sm-icon sm-heart ml-0 no-bullet">
                      <a href="/" class="text-red sm-heart d-flex align-items-center nav-icon">
                        <svg
                          class="fill-current width-svg opacity"
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 31 29"
                    ...
                    <li class="sm-icon sm-any ml-0 no-bullet">
                      <a class="text-grey sm-any d-flex align-items-center nav-icon" href="/">
                        <svg
                          class="fill-current width-svg opacity"
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 29 30"
                  ...
                  <div class="d-block">
                    <p class="text-lg my-3 max-w-xs">
                      Keep track of your shared expenses and balances with housemates, trips,
                      groups, friends, and family.
                    </p>
                    <a
                      class="btn d-inline-block text-white rounded shadow px-5 py-3 bg-teal"
                      id="cta-button"
                      href="/signup"
                    >
                      Sign up
              ...
              <div className="box-width-58 d-block">
                <div class="mx-auto">
                  <ul>
                    <li class="lg-plane no-bullet">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 600" class="lg-icon">
                        <path
                          class="s-p28 ad1 adu1"
        ...
        {/* <img className="footer-img" src={footer_logo} alt="logo" /> */}
      </div>
    );
  }
}
